        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    item_quantity=input("Please enter the quantity of the menu item ")
                    ...
                    print("Your selsection is not valid")
    ...
    while True:
        ...
        if keep_ordering.lower()=="y":
          ...
          # Since the customer decided to stop ordering, thank them for
            ...
            print("I am sorry I didnt get that. Please try again")
...
for i in range(len(order)):
    ...
    number_space_item=25 - len(name)
    number_space_price=6 - len(str(price))

    # 9. Create space strings
    space_string=" "* number_space_item
